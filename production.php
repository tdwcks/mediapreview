	...
	<article class="about">
		<section class="hero">
			...
			<div class="grid-container">
				<div class="row">
					<div class="col-6">
						<h2>&ldquo;The kind of films mediapreview produce don&rsquo;t sit on a shelf gathering dust. People watch and use them!&rdquo;</h2>
					</div> <!-- col-6 -->
				</div> <!-- row -->
			</div> <!-- grid-container -->
		</section> <!-- hero -->
		<section class="longform">
			<div class="grid-container">
				<div class="row">
					<div class="col-6">
						<p class="large">Mediapreview&rsquo;s Andy Wicks and his associates have been making videos and screen media products for commercial, public sector and community clients for the past 30 years.</p>
							...
							<div class="swiper-container">
						        <div class="swiper-wrapper">
						           <div class="swiper-slide">
				            			<p>&ldquo;Mediapreview and Longley Farm have worked together for nearly twenty years now. They can put together all that is needed from idea to edit; from script to soundtrack. They are totally reliable and you can be sure of a good result.&rdquo;</p>
				            			<h5>Jim Dickinson, Longley Farm</h5>
						            </div>
						            <div class="swiper-slide">
				            			<p>&ldquo;Andy is always a pleasure to work with; making people he films feel at ease, totally understanding the brief, editing sensitively and delivering edited material on time and in a variety of formats. Andy is friendly, reliable, professional and the results are always of a very high standard. The kind of films he produces don&rsquo;t sit on a shelf gathering dust. People watch and use them!&rdquo;</p>
				            			<h5>Kim Strickson, Kirklees MC</h5>
						            </div>
						             <div class="swiper-slide">
				            			<p>&ldquo;Mediapreview are a highly professional company who marry first class technical skills to a ready understanding  of a brief, and a passion for getting behind a subject.&rdquo;</p>
				            			<h5>Nancy Barrett, Creative Scene</h5>
						            </div>
						            <div class="swiper-slide">
				            			<p>&ldquo;Andy is great to work with and brings a touch of class to any film. His easy going and sensitive manner helps put nervous interviewees at ease, his thoughtful and creative approach helps find the story in any situation and a great structure to tell it, and his sublime editing skills efficiently draws out the best from any material to produce yet another compelling programme.&rdquo;</p>
				            			<h5>Chris Squire, Impossible Arts</h5>
				            		</div>
						            <div class="swiper-slide">
				            			<p>&ldquo;I had the great privilege of recently working with Andy Wicks. With Andy's expert editing skills and guidance we made a short film that I am really proud of. Andy is calm, patient and caring in his work and he taught me a lot along the way. He is totally reliable and trustworthy and a pleasure to work with. I cannot thank Andy enough and will definitely work with him again and recommend his editing skills to all my friends and colleagues.&rdquo;</p>
